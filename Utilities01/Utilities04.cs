...
namespace Utilities
{
    public class Utilities04
    {
        ...
        public string AddParaHtml(string source) //I have changed the name AddParaHTML to AddParaHtml. Becouse it did not fuction properly so it did not allow the program to compile.
        {
